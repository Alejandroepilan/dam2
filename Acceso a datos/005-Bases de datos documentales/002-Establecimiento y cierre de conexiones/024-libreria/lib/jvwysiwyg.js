...
textos.forEach(function (textarea) {
  ...
  botonsubrayado.onclick = function () {
    reemplaza("text-decoration", "underline");
  };
  ...
  colorfrente.oninput = function () {
    reemplaza("color", colorfrente.value);
  };
  ...
  tamaniofuente.onchange = function () {
    reemplaza("font-size", tamaniofuente.value);
  };
